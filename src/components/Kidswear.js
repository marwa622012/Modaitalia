...
return (
    <div className="row mx-0 my-5 mx-5 all ">
    ...
    />
        ...
        <Link className="shirt-card col-3" to="#">
            <img src={ img1} alt="shirt" className="shirt-image  col-3 "/>
        </Link>
        <Link className="shirt-card col-3 mb-5"to="#">
            <img src={img2} alt="shirt" className="shirt-image  col-3 "/>
        </Link>
        <Link  className="shirt-card col-3 mb-5"to="#">
            <img src={img3} alt="shirt" className="shirt-image  col-3 "/>
        </Link>
        <Link  className="shirt-card col-3 mb-5"to="#">
            <img src={img4} alt="shirt" className="shirt-image  col-3 "/>
        </Link>
        <Link  className="shirt-card col-3"to="#">
            <img src={img5} alt="shirt" className="shirt-image  col-3 "/>
        </Link>
        <Link  className="shirt-card col-3"to="#">
            <img src={img6} alt="shirt" className="shirt-image  col-3 "/>
        </Link>
        <Link  className="shirt-card col-3"to="#">
            <img src={img9} alt="shirt" className="shirt-image  col-3 "/>
        </Link>
        <Link  className="shirt-card col-3"to="#">
            <img src={img10} alt="shirt" className="shirt-image  col-3 "/>
        </Link>
        <Link  className="shirt-card col-3"to="#">
            <img src={img11} alt="shirt" className="shirt-image  col-3 "/>
        </Link>
    </div>
);
}
